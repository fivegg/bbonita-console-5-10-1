...
import org.bonitasoft.forms.client.view.widget.FormButtonWidget.EventHandlerRegistration;
...
public class ImageWidget extends Composite implements HasClickHandlers, ClickHandler {
     ...
     */
    public ImageWidget(final String formID, Map<String, Object> contextMap, final boolean isCurrentValue, final String value, final String imageStyle, final boolean displayAttachmentImage) {
        ...
        if (displayAttachmentImage) {
            ...
            final String imageURL = URLUtils.getInstance().getAttachmentURL(imageServletURL, formID, contextMap, isCurrentValue, value);
     ...
     * @param value the URL of the image or the attachment name
     */
