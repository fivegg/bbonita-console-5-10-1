...
public class DOMUtils {
    ...
    /**
     * simulate a click on the console refresh button (in case the form module is used inside the console)
     * 
    ...
    /*-{
        ...
        if (formFrameWindow != window.top) {
            ...
            var refreshContainerElement = consoleWindow.document.getElementById("WidgetRefreshCasesContainer");
            if (refreshContainerElement!= null) {
                ...
                if (refreshElement != null) {
                    try {//for ie
                        ...
                        evt.initMouseEvent("click", true, true, consoleWindow, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
    ...
    /**
     * simulate a click on the back to inbox button (in case the form module is used inside the console)
     * 
     * @return true if the frame was found, false otherwise
     */
    ...
    /*-{
        ...
        if (formFrameWindow != window.top) {
            var consoleWindow = formFrameWindow.parent;
            var refreshElement = consoleWindow.document.getElementById("backToInboxButton");
            if (refreshElement != null) {
                try {//for ie
                    refreshElement.click();
                } catch(e) {//for ff
    ...
    /**
     * redirect to the case editor (in case the form module is used inside the console)
     * 
    ...
    /*-{
        ...
        if (formFrameWindow != window.top) {
            ...
            if (refreshElement != null) {
                try {
                    consoleWindow.location.hash = encodeURI("#CaseEditor/jou:" + processInstanceUUIDStr);
                } catch(e1) {
                    try {//for ie
                        refreshElement.click();
                    } catch(e2) {//for ff
