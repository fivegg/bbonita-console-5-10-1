...
public final class XMLForms {
    ...
    /**
     * the forms definition welcome page
     */
    ...
    /**
     * the variable binding element name
     */
    public static final String VARIABLE_BINDING = "variable-binding";
    
    /**
     * the variable bound element name
     */
    public static final String VARIABLE_BOUND = "variable-bound";
    ...
    /**
     * the variable type element name
     */
    public static final String VARIABLE_TYPE = "variable-type";
    
    /**
     * the attachment element name
     */
    ...
    /**
     * the output parameters element name
     */
    public static final String OUTPUT_PARAMETERS = "output-parameters";

    /**
     * the output parameter element name
     */
